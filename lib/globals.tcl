...
set vTcl(pr,gui_font_tooltip)   TkTooltipFont      ;# Rozen
...
set vTcl(color_options) \
	[list -activebackground -activeforeground -background -disabledforeground \
	 -foreground -highlightbackground -highlightcolor -insertbackground \
	 -insertbackground -selectbackground -selectcolor -selectforeground \
	 -troughcolor -disabledbackground]

set vTcl(menu_color_options) \
	[list -activebackground -activeforeground -background \
