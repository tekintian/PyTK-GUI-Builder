# page-sky based on cornsilk-light
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Blue light theme.
# -------------------------------
# A semi-light theme originally created for users of PAGE based on notsodark
# -------------------------------
...
namespace eval ttk::theme::page-sky {
    variable version 0.2.9.1
    package provide ttk::theme::page-sky $version
    variable colors
    array set colors {
        -disabledfg     gray54
        -frame          black
        ...
        -texthighlight   slategray3
        -readonlycolor   indianred1
    }


    # Settings
    ttk::style theme create page-sky -parent clam -settings {
        ...
        load_images [file join [file dirname [info script]] page-sky]
