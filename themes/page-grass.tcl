...
# page-grass theme
#
# green grass light theme.
# -------------------------------
# A green theme originally created for users of PAGE based on notsodark
# -------------------------------
...
namespace eval ttk::theme::page-grass {
    variable version 0.2.7
    package provide ttk::theme::page-grass $version
    variable colors
    array set colors {
        -disabledfg     gray54
        -frame          black
        ...
        -bgcolor        springgreen2
        -fgcolor        black
        -activebgcolor  springgreen3
        -troughcolor    gray65
        -barcolor       springgreen3
        -fieldbgcolor   black
        -bordercolor    dimgray
        -tvwindow       palegoldenrod
        -tvwindowdisabled  burlywood2
    ...
    # Settings
    ttk::style theme create page-grass -parent clam -settings {
        ...
        load_images [file join [file dirname [info script]] page-grass]
        ...
        ttk::style map TCombobox $colors(-tvwindow) \
        ...
        # Create a border around the listbox dropdown item
        ...
        ttk::style configure TProgressbar -background $colors(-bgcolor) \
            -troughcolor $colors(-troughcolor) -bordercolor $colors(-frame) \
            -lightcolor $colors(-lightcolor) \
            -darkcolor gray19 -pbarrelief sunken -arrowsize 2
